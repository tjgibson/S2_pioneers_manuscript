...
# define input files ===========================================================
meme_files <- c(
  # "results/ChIP_tissue_classes/motifs/twi_class_I/combined.meme",
  # "results/ChIP_tissue_classes/motifs/twi_class_II/combined.meme",
  # "results/ChIP_tissue_classes/motifs/twi_class_III/combined.meme",
  "results/ChIP_tissue_classes/motifs/twi_class_IV/combined.meme",
  "results/ChIP_tissue_classes/motifs/twi_class_V/combined.meme",
  "results/ChIP_tissue_classes/motifs/twi_class_VI/combined.meme"
)
...
tissue_classes <- "results/ChIP_tissue_classes/twi_tissue_classes.tsv" |> 
  read_tsv() |> 
...
pdf("exploratory_analysis/twi_denovo_motifs_heatmap.pdf", height = 12, width = 8)
