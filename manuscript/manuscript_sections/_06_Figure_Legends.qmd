...
**j,i,** Proportion of class I, II or III regions that is proximal to a gene that is upregulated upon Zld **(j)** or Grh **(i)** expression.
...
Remaining ChIP-seq datasets were previously published (see Supplementary table 1)[@Henriques2018;@Philip2015;@Tettey2019].
...
Percentages are shown for class I, II or III binding sites, or all wild-type ATAC-seq peaks as a control for the background motif frequency.
...
ChIP-seq data for repressive histone modifications H3K27me3 [@Jain2020] and H3K9me3[@Eastwood2021] in WT S2 cells is also shown.
...
**Figure 5: Pioneer-factor binding and opening of closed chromatin is concentration dependent. a,e,i,** Metaplots of ChIP-seq signal at class I-VI regions for Zld **(a)**, Grh **(e)**, or Twi **(i)** when expressed at different levels.
...
**e-f,** Heatmaps comparing Zld **(e)**, Grh **(f)**, or Twi **(g)** ChIP-seq signal to control experiments in which anti-Zld, anti-Grh, anti-Twi, or IgG antibodies were used to perform immunopreciptation in WT cells.
...
**b,e,** RNA-seq volcano plots showing gene expression changes in cells expressing Zld **(b)** or Grh **(e)** when compared to WT cells treated with the same concentration of CuSO~4~.
...
**Extended Data Figure 6: Zld, Grh and Twi do not bind preferentially to motifs in a particular position on nucleosomes. a-c,** Metaplots showing average MNase signal from WT cells centered on motifs within class I, II, or III regions for Zld **(a)**, Grh **(b)**, or Twi **(c)**.
...
**Extended Data Figure 8: Specific detection of H3K27me3 in tazemtostat-treated cells. a,** Immunoblot showing H3K27me3 levels in two replicates of DMSO- or tazemetostat-treated cells.
...
Stable cell lines are compared to WT cells.

**Supplementary table 1:** List of previously published genomics datasets that were analyzed in this work.
