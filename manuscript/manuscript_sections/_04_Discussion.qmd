...
By comparing the results of TF induction in S2 cells to Zld, Grh and Twi activity during normal development, we are able to provide mechanistic insights into how PFs are regulated in different cell types, and how PF binding relates to function.
...
Local restructuring of nucleosome-DNA interactions [@Michael2020; @Dodonova2020], if it occurs in the case of Zld, Grh, or Twi, may be insufficient for establishing accessible chromatin and may instead stabilize PF binding to allow recruitment of cofactors.
We find that pioneering activity requires a high level of chromatin occupancy that can be achieved through both protein-intrinsic and protein-extrinsic features such as local chromatin features, protein concentration, DNA motif content, and protein domains outside the DBD.
...
These results suggest that despite the correlation with H3K27me3, protein concentration and affinity for target motifs may be more important than the presence of polycomb silencing for tissue-specific.
...
Due to the essential role of PFs in regulating cell fate, their misexpression frequently results in disease [@Larson2021; @Dobersch2019].
GRHL2, one the mammalian Grh orthologs, is frequently subject to copy number amplification in various cancers, leading to overexpression, and can act as either a tumor suppressor or an oncogene, depending on the context [@Reese2019].
Misexpression of the PF DUX4 results in the muscular atrophy disease facioscapulohumeral muscular dystrophy (FSHD) [@Campbell2018].
Our data provide evidence for how misexpression and overexpression of PFs can lead to ectopic activation of gene-regulatory programs.
A better understanding of how PF binding and activity is regulated will be essential for understanding and treating diseases caused by these proteins.
