...
We find that pioneering activity requires a high level of chromatin occupancy that can be achieved through both protein-intrinsic and protein-extrinsic features such as local chromatin structure, protein concentration, DNA motif content, and protein domains outside the DBD (Fig. 6g).
...
For Zld, this disordered domain is required for transcriptional activation and promotes nucleosome binding *in vitro* [@Hamm2015; @McDaniel2019a].
IDRs may contribute to TF binding through protein-protein interactions with other transcription factors, nonspecific interactions with DNA, or by driving condensate formation [@Brodsky2021; @Staller2022].
