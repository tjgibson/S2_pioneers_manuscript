...
In the case of Pax7, a PF important for specification of pituitary melanotropes, H3K27me3 is correlated with cell-type specific Pax7 binding [@Mayran2019].
...
-   discuss Zld and Grh data

-   mention Barkai and Staller reviews and models of IDR specificity: interactions with DNA, condensate formation, protein-protein interactions

-   propose that interactions with nucleosomes is another model for how IDRs affect specificty.
    Support this with Kath's EMSA data for Zld.
    Cite Zaret papers as additional examples.
    Could mention Giraldez data as well.

-   Wrap up by mentioning that future directions could more fully explore how IDRs contribute to binding and specificity of PFs and non-PFs.

**P1: advantages of our study, summary of findings and our model**

**P2: The effect of chromatin on binding: contextualize with references to past work by Zaret, Drouin, Mahony, and Giraldez and Onitchouk. Emphasize the importance of functionally testing correlative relationships. Mention potential importance of cofactors.**

**P3: the effect of concetration on binding. Mention that this could explain differences in Grh pioneering during development. Mention that Grh is overexpressed in cancers, so this has disease relevance. Mention Cohen studies.**

P4: Discussion of DBD and conclusion.
Discuss potential models and mention importance for understanding disease and reprogramming.
Mention Zaret, Barkai and Scholer reprogramming paper.
Concluding statement and any comments on future directions.
