...
Imaging was performed at 60X on a Nikon Ti2 epi-fluorescent microscope.
...
Data from ChIP experiments performed with the same antibody in WT cells were used as a control for peak calling.
...
Previously published datasets analyzed in this study can be found in supplemental table 1.
