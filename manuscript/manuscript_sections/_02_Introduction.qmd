...
By comparing the features of these factors and relating exogenous activity to *in vivo* functionality, we demonstrate that pioneering depends on a combination of local chromatin structure, sequence context, and PF concentration.
