...
Thus, PF activity is regulated at a step other than chromatin binding.
...
Oct4 binding to nucleosomes can result in local remodeling of histone-DNA interactions, especially at the nucleosome entry-exit site [@Michael2020].
...
The essential roles of Zld and Grh in diverse biological processes and the well-documented context-dependent binding and activity of these factors makes them excellent models to explore how PF binding is regulated and how PF occupancy relates to chromatin opening.
Because many previous studies have relied on loss-of-function experiments, it has been difficult to disentangle causal relationships between chromatin structure and PF activity.
We therefore expressed Zld and Grh in Drosophila Schneider 2 (S2) cells, where neither factor is endogenously expressed.
When ectopically expressed, Zld and Grh bind to closed chromatin, establish chromatin accessibility, and promote transcriptional activation at a subset of binding sites.
